...
public abstract class APkmnParser
{
    ...
    protected abstract EVs ParseEVs(ReadOnlySpan<byte> data);
    protected abstract IVs ParseIVs(ReadOnlySpan<byte> data);
    protected abstract Stats ParseStats(ReadOnlySpan<byte> data);
