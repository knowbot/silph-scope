...
namespace SilphScope.Models.Games.Parsers.Common
{
	...
	{
		private static readonly int[] natureStatsLookup = [0, 1, 4, 2, 3, 5, 6, 9, 7, 8, 20, 21, 24, 22, 23, 10, 11, 14, 12, 13, 15, 16, 17, 18, 19];
		...
		public static Stats GetStats(Species species, IVs ivs, EVs evs, int level, Nature nature)
		{
			...
			// Account for nature.
			int natureIndex = natureStatsLookup[(int)nature];
