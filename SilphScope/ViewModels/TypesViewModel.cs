...
{
    private static readonly BrushCache s_brushes = new();
    ...
    public void UpdateGameState(Types? type1, Types? type2)
    {
        ...
        Brush1 = s_brushes.Get(Color.Parse(ColorAttribute.Get(type1)!));
        if (type2 != null)
        {
            Brush2 = s_brushes.Get(Color.Parse(ColorAttribute.Get(type2)!));
        }
        else
        {
            Brush2 = null;
